...
<body class="overflow-x-hidden">
 ...
 <!-- Banner Section -->
  <div id="banner-section"class="mx-10 mt-20 rounded-lg border hidden md:block">
   ...
   <img alt="Combox Menu Banner" class="w-full h-full object-cover height="500" src="img/menu1.png" width="1920"/>
  ...
  <section class="text-center my-8">
   ...
   <div class="flex justify-center space-x-4 mt-4">
    <a href="/menu" class="bg-black text-white py-2 px-4 rounded-full">
     All Types
    </a>
    <a href="/menu/main-course" class="bg-gray-200 text-gray-700 py-2 px-4 rounded-full">
     Main Courses
    </a>
